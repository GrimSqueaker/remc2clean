...
char sub_7DE80(int a1, int a2)//25ee80
{
	...
	*(x_DWORD *)(a2 + 4) = 0;
	...
	LOWORD(v4) = xy_DWORD_17DED4_spritestr[72].width;
	...
	v13 = sub_5BE80_test_pallette((unsigned __int8 *)x_DWORD_17DE38str.x_DWORD_17DE38, 0, 0, 0);
	...
	{
		sub_6FC50(1);
		v15 = sub_5BE80_test_pallette((unsigned __int8 *)x_DWORD_17DE38str.x_DWORD_17DE38, 0, 0, 0);
		sub_2BC10_draw_text((char*)"_", v14 - 2, (__int16)v5, v15);
...
LABEL_13:
	if (v23)
	{
		...
		if ((x_BYTE)v5 == 1)
		{
			...
			*(x_DWORD *)(a2 + 4) = sub_77680(v17, v5) != 0;
