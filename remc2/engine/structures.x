int /*__cdecl*/ sub_main(int argc, char **argv, char **envp)//236F70
	...
	void sub_46830_main_loop(int16_t *a1, signed int a2, uint16_t a3)//227830
		signed int /*__fastcall*/ sub_76930(int a2, int16_t *a3)//257930
...
*(x_BYTE *)(x_D41A0_BYTEARRAY_0 + 8 * (int16_t)result + 0x365F6) = *(x_BYTE *)(8 * (int16_t)result + a1 + 0x65AD)
*(_WORD *)(&x_D41A0_BYTEARRAY_0[0x30313	+ 20 * *(_WORD *)(&x_D41A0_BYTEARRAY_0[0x3647c + 8 * v6])])

if (x_D41A0_BYTEARRAY_0[8 * *(uint8_t *)(a1 + 72) + 0x365F6])
...
void sub_17A00(Bit8u* a1, signed int a2, int16_t a3)//1f8a00

		v3 = x_DWORD_EA3E4[*(uint16_t *)(2124 * D41A0_BYTESTR_0.word_0xc + x_D41A0_BYTEARRAY_0 + 11240)];
